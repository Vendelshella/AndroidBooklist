...
fun BookDetailScreen(
    ...
    LaunchedEffect(Unit) {
        isAdded = database.findByIsbn(isbn) != null
    }
        ...
        Column(
            ...
            Row {
                ...
                Column(modifier = Modifier.weight(1f)) {
                    Column {
                        Text(
                            text = "- Autor: ${thisBook.book.author.name}",
                        ...
                        Text(
                            text = "- Año de publicación: ${thisBook.book.year}",
                            style = MaterialTheme.typography.labelLarge
                        )
                        ...
                        Text(
                            text = "- ${thisBook.book.pages} páginas",
                            style = MaterialTheme.typography.labelLarge
                        )
                ...
                Button(
                    onClick = {
                        coroutineScope.launch {
                            val candidate = database.findByIsbn(isbn)
